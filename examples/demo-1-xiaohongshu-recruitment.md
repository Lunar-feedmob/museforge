...
Rationale: the Editorial Poster recipe matches the recruitment marketing use case; the Editorial Text-first Poster pattern fits the visual goal; the editorial minimalism style matches the requested aesthetic; 5 technique(s) apply to this task.
...
## Key Techniques
text rendering, visual hierarchy, whitespace / negative space, negative constraints, reference image
...
pattern: Cinematic Character Portrait; style: modern Chinese editorial

## Notes
- Watch for: text garble, cluttered layout
- Pattern pitfalls: text garble, cluttered layout
